...
export default function Header() {
  ...
  return (
    ...
    <header className="sticky top-0 z-50 border-b border-gray-600" style={{ backgroundColor: "#272752" }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="border-t border-gray-600 backdrop-blur-sm shadow-lg" style={{ backgroundColor: "rgba(39, 39, 82, 0.95)" }}>
